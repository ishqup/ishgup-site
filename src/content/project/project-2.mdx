...
The level of toughness of the game is marked according by a 1 within the table indicating both the home and away team's win/loss status. During this
...
as follows: 3(NW)*1 + 2(TW)*1.375 + 1(EW)*0.625 + 1(NL)*0 + 1(TL)*0.375 - 2(EL)*3.75 = 6.625
