...
and was projected to score the most he ended up getting injured and unperfoming significantly. These predicitons assume the
player will not get injured over the season. However, this is the case with a lot of these players, as they get injuries 
(minor or major) they will miss games. We can likely attribute as a possible reason for the actual scores underperforming 
